...
exports.createKvCache = createKvCache;
const cache_key_js_1 = require("./cache-key.js");
const invalidate_js_1 = require("./invalidate.js");
    ...
    return function KVCacheFactory(ctx) {
        return {
            get(id) {
                ...
                const operationKey = (0, cache_key_js_1.buildOperationKey)(id, config.keyPrefix);
            ...
            ttl) {
                ...
                const setPromise = (0, set_js_1.set)(id, data, entities, ttl, ctx[config.KVName], config.keyPrefix);
                if (!ctx.waitUntil) {
                    // eslint-disable-next-line no-console
            ...
            invalidate(entities) {
                ...
                const invalidatePromise = (0, invalidate_js_1.invalidate)(entities, ctx[config.KVName], config.keyPrefix);
                if (!ctx.waitUntil) {
                    // eslint-disable-next-line no-console
