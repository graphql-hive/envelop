...
describeIf(graphql_1.versionInfo.major >= 16)('useResponseCache with Redis cache', () => {
    const redis = new ioredis_1.default();
    const cache = (0, index_js_1.createRedisCache)({ redis });
    beforeEach(async () => {
        jest.useRealTimers();
        await redis.flushall();
    });
    test('should create a default entity id with a number id', () => {
        const entityId = (0, index_js_1.defaultBuildRedisEntityId)('User', 1);
        expect(entityId).toEqual('User:1');
    });
    test('should create a default entity id with a string id', () => {
        const entityId = (0, index_js_1.defaultBuildRedisEntityId)('User', 'aaa-bbb-ccc-111-222');
    ...
    test('should create a default key used to cache associated response operations', () => {
        const entityId = (0, index_js_1.defaultBuildRedisOperationResultCacheKey)('abcde123456XYZ=');
    ...
    test('should reuse cache', async () => {
      ...
      `,
        ...
        const testInstance = (0, testing_1.createTestkit)([(0, response_cache_1.useResponseCache)({ session: () => null, cache })], schema);
        const query = /* GraphQL */ `
      query test {
        users {
          id
    ...
    test('should indicate if the cache was hit or missed', async () => {
      ...
      `,
        ...
        const testInstance = (0, testing_1.createTestkit)([(0, response_cache_1.useResponseCache)({ session: () => null, cache, includeExtensionMetadata: true })], schema);
        const query = /* GraphQL */ `
      query test {
        users {
          id
    ...
    `;
        ...
        (0, testing_1.assertSingleExecutionValue)(queryResult);
        ...
        (0, testing_1.assertSingleExecutionValue)(cachedResult);
      ...
      `, {
        ...
        (0, testing_1.assertSingleExecutionValue)(mutationResult);
    ...
    test('should purge response after it expired', async () => {
      ...
      `,
        ...
        const testInstance = (0, testing_1.createTestkit)([(0, response_cache_1.useResponseCache)({ session: () => null, cache, ttl: 100 })], schema);
        const query = /* GraphQL */ `
      query test {
        users {
          id
    ...
    test('should skip cache of ignored types', async () => {
      ...
      `,
        ...
        const testInstance = (0, testing_1.createTestkit)([(0, response_cache_1.useResponseCache)({ session: () => null, cache, ignoredTypes: ['Comment'] })], schema);
        const query = /* GraphQL */ `
      query test {
        users {
          id
