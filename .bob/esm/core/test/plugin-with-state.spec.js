...
describe('pluginWithState', () => {
    const plugin = withState(() => ({ hook: (...args) => args }));
    ...
    it('should allow to have attribute that are not function', () => {
        const plugin = withState(() => ({ test: 'test' }));
    ...
    describe('instrumentation', () => {
        const plugin = withState(() => ({ instrumentation: { hook: (...args) => args } }));
        it('should add request state', () => {
    ...
    describe('getMostSpecificState', () => {
        it('should return the most specific state', () => {
            ...
            expect(getMostSpecificState({ forOperation, forSubgraphExecution })).toBe(forSubgraphExecution);
            expect(getMostSpecificState({ forOperation, forRequest, forSubgraphExecution })).toBe(forSubgraphExecution);
        });
    });
});
