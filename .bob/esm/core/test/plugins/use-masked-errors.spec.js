...
import { createDefaultMaskError, DEFAULT_ERROR_MESSAGE, useMaskedErrors, } from '../../src/plugins/use-masked-errors.js';
describe('useMaskedErrors', () => {
    ...
    it('should use custom error mask function for execution errors', async () => {
        const customErrorMaskFn = e => new GraphQLError('Custom error message for ' + e, null, null, null, null, null, {
            custom: true,
        });
