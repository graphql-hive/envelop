...
test('getFieldIdentity with identity args', () => {
    ...
    expect(getFieldIdentity('myField', ['name', 'bool'], { bool: true, name: 'Foo' })).toBe('myField:Foo:true');
...
test('getFieldIdentity with nested identity args', () => {
    expect(getFieldIdentity('myField', ['item.id'], { item: { id: 2 }, name: 'Foo' })).toBe('myField:2');
    expect(getFieldIdentity('myField', ['item.foo'], { item: { id: 2 }, name: 'Foo' })).toBe('myField:');
