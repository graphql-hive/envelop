...
import { cacheControlDirective, createInMemoryCache, defaultBuildResponseCacheKey, useResponseCache, } from '../src/index.js';
describe('useResponseCache', () => {
    ...
    it('should cache queries using @stream', async () => {
      ...
      `,
        ...
        const testInstance = createTestkit(envelop({
            plugins: [
